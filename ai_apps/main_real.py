...
#important to specify the doc strings precisely, helps model understand the function better
...
"""
# include model, tools and system prompt. Use create_agent to initialize an agent
